...
if __name__ == "__main__":
    ...
    # Setup subscriber
    rospy.Subscriber('/d455/depth/color/points', PointCloud2, callback_roscloud, queue_size=1)
    ...
    while not rospy.is_shutdown():
        ...
        if not received_ros_cloud is None:
            ...
            print("\n ************* Before anything ************* ")
            rviz_cloud = orh.o3dpc_to_rospc(received_open3d_cloud, frame_id="d455_depth_optical_frame")
#            pub_capture.publish(rviz_cloud)
